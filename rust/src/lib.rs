...
//!     snarkvm_types::{Address, PrivateKey, TestnetV0, Program},
//!     TransferType
//!   };
//!   use rand::thread_rng;
//!   use std::str::FromStr;
...
//!   let mut program_manager = ProgramManager::<TestnetV0>::new(None, Some(private_key_ciphertext), Some(api_client), None, false).unwrap();
//!
//!   // ------------------
